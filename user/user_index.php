...
<?php
    ...
    $sql_query = "SELECT * FROM phone_user ORDER BY id ASC";
    //$result = mysqli_query($db_link,$sql_query);
...
<div id="Body">
	...
	<h1 align = "center">使用者資料總表</h1>
	<p align= "center">目前資料筆數：<?php echo $counnt;?>，<a href='user_create.php'>新增資料</a></p>
	</div>

	<div id="body_process">
		<table style= "border=3 yellow groove;"align = "right" width="1450" border="5">
			<tr>
			<th width="200"> <div align="center"><font color="purple" size="5px">帳號 </font></div></th>
			<th width="100"> <div align="center"><font color="purple" size="5px">密碼</font></div></th>
			<th width="150"> <div align="center"><font color="purple" size="5px">生日 </font></div></th>
			<th width="100"> <div align="center"><font color="purple" size="5px">電話</font></div></th>
			<th width="100"> <div align="center"><font color="purple" size="5px">email</font></div></th>
			<th width="700"> <div align="center"><font color="purple" size="5px">地址</font></div></th>
	...
	foreach($result as $row_result){
		echo "<tr>";
		echo "<td><font color='green' size='5px'>".$row_result['user_name']."</td>";
		echo "<td><font color='green' size='5px'>".$row_result['user_password']."</td>";
		echo "<td><font color='green' size='5px'>".$row_result['user_birthday']."</td>";
		echo "<td><font color='green' size='5px'>".$row_result['user_phone']."</td>";
		echo "<td><font color='green' size='5px'>".$row_result['user_email']."</td>";
		echo "<td><font color='green' size='5px'>".$row_result['user_address']."</td>";
		
		echo "<td><div align='center'><font color='green' size='5px'><a href='user_update.php?id=".$row_result['id']."'>修改</a>"."</br>";
		echo "<font color='green' size='5px'><a href='user_delete.php?id=".$row_result['id']."'>刪除</a></td>";
		echo "</tr>";
