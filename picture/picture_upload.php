...
if (isset($GoUpload) && $GoUpload=='1') {
    ...
    if (!empty($fname) && addslashes($fname)==$fname && $fsize>0 && $fsize<10240000) {
...
$sqlcmd = "SELECT * FROM photo WHERE cid='$cid' AND valid='Y' LIMIT 0,1";
...
<?php if ($PhotoExist) { ?>
<img src="getimage.php?ID=<?php echo $cid ?>" border="0" width="200" />
<?php } else { ?>
